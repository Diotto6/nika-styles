...
declare type StyledButtonVariants = Stitches.VariantProps<typeof ButtonCSS>;
declare type ButtonPropsPrimitive = ComponentProps<typeof ButtonStyled>;
declare type ButtonPrimitiveProps = ButtonPropsPrimitive & {
    css?: CSS;
};
export declare type ButtonProps = ButtonPrimitiveProps & ComponentProps<typeof ButtonStyled> & {
